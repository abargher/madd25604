...
def handleFrame(frame):
    ...
    maybeOutput("hand", vis, frame_idx)
    frame_idx+=1
    return dict(posepoints=[[(landmark.x, landmark.y, landmark.z) for landmark in face] for face in face_landmarker_result.hand_landmarks])
